...
export default function AdComp({ img, logo, title, section, color, height }) {
  ...
  return (
    <div className="rounded col-span-5 lg:col-span-4 h-[70%] bg-black md:m-4 overflow-hidden">
      <div
        className="grid grid-cols-4 h-[200px] md:h-[350px]"
        style={{ height }}
      >
        <div className="text-white mx-10 flex flex-col justify-around">
          <div className="flex items-center">
            {logo && logo}
            <h2 className="hidden sm:block md:text-xl lg:text-2xl">{title}</h2>
          </div>
          <h3
          ...
          <div
            ...
            className={`flex items-center hover:translate-x-5 duration-300 transition-all hover:underline`}
          >
            <h3
        ...
        <div className="col-span-3 md:flex justify-center overflow-hidden sm:scale-90 translate-y-15 hover:translate-y-10 transition-all">
          <img
            className=" hover:scale-3d hover:motion-safe:animate-pulse duration-500 transition-all"
            src={`${img}`}
            alt=""
          />
        </div>
